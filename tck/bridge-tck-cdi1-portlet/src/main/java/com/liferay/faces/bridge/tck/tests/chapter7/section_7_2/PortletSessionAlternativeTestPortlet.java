...
@PortletConfiguration(
	portletName = "chapter7_2CDITests-portletSessionAlternativeTest-portlet",
	initParams = {
			@InitParameter(
...
public class PortletSessionAlternativeTestPortlet extends GenericFacesTestSuitePortlet {
}
