...
@PortletConfiguration(
	portletName = "chapter7_2CDITests-portletPreferencesAlternativeTest-portlet",
	initParams = {
			@InitParameter(
				name = "com.liferay.portlet.faces.defaultViewId.view", value = "/WEB-INF/views/singleRequestTest.xhtml"
			)
		}, roleRefs = {
...
public class PortletPreferencesAlternativeTestPortlet extends GenericFacesTestSuitePortlet {
}
