...
@PortletConfiguration(
	portletName = "chapter7_2CDITests-portletRequestScopedBeanTest-portlet",
	initParams = {
			@InitParameter(
...
public class PortletRequestScopedBeanTestPortlet extends GenericFacesTestSuitePortlet {
}
