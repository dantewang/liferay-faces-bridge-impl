...
@PortletConfiguration(
	portletName = "chapter7_2CDITests-resourceResponseAlternativeTest-portlet",
	initParams = {
			@InitParameter(
				name = "com.liferay.portlet.faces.defaultViewId.view", value = "/WEB-INF/views/resourceAjaxResult.xhtml"
			)
		}, roleRefs = {
...
public class ResourceResponseAlternativeTestPortlet extends GenericFacesTestSuitePortlet {
}
