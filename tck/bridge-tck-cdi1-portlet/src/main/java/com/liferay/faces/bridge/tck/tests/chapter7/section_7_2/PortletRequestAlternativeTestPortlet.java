...
@PortletConfiguration(
	portletName = "chapter7_2CDITests-portletRequestAlternativeTest-portlet",
	initParams = {
			@InitParameter(
...
public class PortletRequestAlternativeTestPortlet extends GenericFacesTestSuitePortlet {
}
