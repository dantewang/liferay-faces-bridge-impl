...
@PortletConfiguration(
	portletName = "chapter7_2CDITests-bridgeRequestScopedBeanTest-portlet",
	initParams = {
			@InitParameter(
...
public class BridgeRequestScopedBeanTestPortlet extends GenericFacesTestSuitePortlet {
}
