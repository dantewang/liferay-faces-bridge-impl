...
import com.liferay.portlet.faces.BridgePublicRenderParameterHandler;
...
public class Tests extends Object implements PhaseListener, BridgePublicRenderParameterHandler {
	...
	public String checkViewHistoryTest(TestBean testBean) {
		...
		String view = (String) sessionMap.get("com.liferay.portlet.faces.viewIdHistory.view");
		String edit = (String) sessionMap.get("com.liferay.portlet.faces.viewIdHistory.edit");
		String help = (String) sessionMap.get("com.liferay.portlet.faces.viewIdHistory.help");

		if (view == null) {
			testBean.setTestResult(false, "com.liferay.portlet.faces.viewIdHistory.view session attribute doesn't exist.");

			return Constants.TEST_FAILED;
		}

		if (edit == null) {
			testBean.setTestResult(false, "com.liferay.portlet.faces.viewIdHistory.edit session attribute doesn't exist.");

			return Constants.TEST_FAILED;
		}

		if (help == null) {
			testBean.setTestResult(false, "com.liferay.portlet.faces.viewIdHistory.help session attribute doesn't exist.");
		...
		if (!view.startsWith(defaultViewIdViewMode)) {
			testBean.setTestResult(false,
				"com.liferay.portlet.faces.viewIdHistory.view contains unexpected value. Expected: " + defaultViewIdViewMode +
				" but value was: " + view);
		...
		if (!edit.startsWith(defaultViewIdEditMode)) {
			testBean.setTestResult(false,
				"com.liferay.portlet.faces.viewIdHistory.edit contains unexpected value. Expected: " + defaultViewIdEditMode +
				" but value was: " + edit);
		...
		if (!help.startsWith(defaultViewIdHelpMode)) {
			testBean.setTestResult(false,
				"com.liferay.portlet.faces.viewIdHistory.help contains unexpected value. Expected: " + defaultViewIdHelpMode +
				" but value was: " + help);
	...
	public String navigateToLastViewTest(TestBean testBean) {
		...
		String theHistoryView = (String) externalContext.getSessionMap().get("com.liferay.portlet.faces.viewIdHistory.view");
		String theHistoryEdit = (String) externalContext.getSessionMap().get("com.liferay.portlet.faces.viewIdHistory.view");
