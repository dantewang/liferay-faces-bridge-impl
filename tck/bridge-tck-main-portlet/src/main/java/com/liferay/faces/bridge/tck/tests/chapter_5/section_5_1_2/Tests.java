...
public class Tests {
	...
	public String requestNoScopeOnModeChangeTest(TestBean testBean) {
		...
		if (BridgeUtil.getPortletRequestPhase(facesContext) == Bridge.PortletPhase.ACTION_PHASE) {
			...
			// due to the presence of com.liferay.portlet.faces.PortletMode=edit in the navigation-rule.
	...
	public String requestScopeContentsTest(TestBean testBean) {
		...
		if (BridgeUtil.getPortletRequestPhase(facesContext) == Bridge.PortletPhase.ACTION_PHASE) {
			...
			requestMap.put("com.liferay.portlet.faces.TestRequestScope", REQUEST_ATTR_VALUE);
			...
			o = requestMap.get("com.liferay.portlet.faces.TestRequestScope");

			if (o != null) {
				testBean.setTestResult(false,
					"Attribute in the com.liferay.portlet.faces namesapce unexpectedly retained: com.liferay.portlet.faces.TestRequestScope.");
