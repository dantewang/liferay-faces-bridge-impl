...
public class Tests extends HeaderTests implements PhaseListener {
	...
	public String bridgeSetsContentTypeTest(TestBean testBean) {
		...
		if ((headerResponseContentType == null) && (externalContextResponseContentType != null) &&
				(headerRequestContentType != null) &&
				externalContextResponseContentType.equals(headerRequestContentType)) {
			...
			testBean.setTestResult(false,
				...
				headerRequestContentType + " expected: null");
			...
			testBean.setTestResult(false,
				...
				externalContextResponseContentType + " expected: " + headerRequestContentType);
			...
			if (viewId.equals("/tests/multiRequestTestResultRenderCheck.xhtml")) {
				...
				try {
					externalContext.redirect(viewHandler.getActionURL(facesContext,
							"/tests/redisplayRenderRequestTest.xhtml"));
				}
				catch (IOException e) {
					testBean.setTestComplete(true);
	...
	public String verifyPortletObjectsTest(TestBean testBean) {
		...
		String s = (String) requestMap.get("com.liferay.portlet.faces.tck.verifyPortletObjectsPass");
		...
		if (s != null) {
			...
			testBean.setTestResult(false, (String) requestMap.get("com.liferay.portlet.faces.tck.verifyPortletObjectsFail"));
	...
	public String verifyPortletPhaseTest(TestBean testBean) {
		...
		if (BridgeUtil.getPortletRequestPhase(facesContext) == Bridge.PortletPhase.ACTION_PHASE) {
			...
			String s = (String) requestMap.get("com.liferay.portlet.faces.tck.verifyPortletPhaseDuringActionPass");
			String s1 = (String) requestMap.get("com.liferay.portlet.faces.tck.verifyPortletPhaseDuringRenderPass");
			...
			if (s == null) {
				s = (String) requestMap.get("com.liferay.portlet.faces.tck.verifyPortletPhaseDuringActionFail");
			}

			if (s1 == null) {
				s1 = (String) requestMap.get("com.liferay.portlet.faces.tck.verifyPortletPhaseDuringRenderFail");
			}
