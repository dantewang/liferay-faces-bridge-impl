...
public class TCK_FacesContextFactoryImpl extends FacesContextFactory {
	...
	private void verifyLifecycle(PortletContext context, PortletRequest portletRequest, Lifecycle lifecycle) {
		...
		if (id != null) {
			...
			if (l == lifecycle) {
				portletRequest.setAttribute("com.liferay.portlet.faces.tck.testLifecyclePass",
					"Correctly used the configured lifcycle: " + id);
			}
			else {
				portletRequest.setAttribute("com.liferay.portlet.faces.tck.testLifecycleFail",
	...
	private void verifyPortletObjects(Object context, Object request, Object response) {
		...
		if ((context instanceof PortletContext) && (request instanceof PortletRequest) &&
			...
			((PortletRequest) request).setAttribute("com.liferay.portlet.faces.tck.verifyPortletObjectsPass",
				"Correctly passed a PortletContext, PortletRequest, and PortletResponse in acquiring a FacesContext");
		}
		else {
			((PortletRequest) request).setAttribute("com.liferay.portlet.faces.tck.verifyPortletObjectsFail",
	...
	private void verifyPortletPhase(PortletRequest portletRequest) {
		Bridge.PortletPhase phase = (Bridge.PortletPhase) portletRequest.getAttribute("com.liferay.portlet.faces.phase");

		if (portletRequest instanceof ActionRequest) {

			if ((phase != null) && (phase == Bridge.PortletPhase.ACTION_PHASE)) {
				portletRequest.setAttribute("com.liferay.portlet.faces.tck.verifyPortletPhaseDuringActionPass",
					"Phase attribute correctly set during action ... ");
			}
			else {
				portletRequest.setAttribute("com.liferay.portlet.faces.tck.verifyPortletPhaseDuringActionFail",
			...
			if (Bridge.PortletPhase.HEADER_PHASE.equals(phase)) {
				portletRequest.setAttribute("com.liferay.portlet.faces.tck.verifyPortletPhaseDuringRenderPass",
					"Phase attribute correctly set during render.");
			}
			else {
				portletRequest.setAttribute("com.liferay.portlet.faces.tck.verifyPortletPhaseDuringRenderFail",
