	...
	public String getActionURL(FacesContext facesContext, String viewId) {
		...
		if (Bridge.PortletPhase.HEADER_PHASE.equals(BridgeUtil.getPortletRequestPhase(facesContext))) {
			...
			if (testName.equals("encodeActionURLWithParamRenderTest")) {
				...
				return appendQueryString(resultURL, "com.liferay.portlet.faces.PortletMode=edit&param1=testValue");
			}
			else if (testName.equals("encodeActionURLWithInvalidModeRenderTest")) {
				return appendQueryString(resultURL, "com.liferay.portlet.faces.PortletMode=blue&param1=testValue");
			}
			else if (testName.equals("encodeActionURLWithWindowStateRenderTest") ||
					testName.equals("encodeResourceURLWithWindowStateTest")) {
				return appendQueryString(resultURL, "com.liferay.portlet.faces.WindowState=maximized&param1=testValue");
			}
			else if (testName.equals("encodeActionURLWithInvalidWindowStateRenderTest")) {
				return appendQueryString(resultURL, "com.liferay.portlet.faces.WindowState=blue&param1=testValue");
			}
			else if (testName.equals("encodeActionURLWithSecurityRenderTest")) {
				return appendQueryString(resultURL, "com.liferay.portlet.faces.Secure=true&param1=testValue");
			}
			else if (testName.equals("encodeActionURLWithInvalidSecurityRenderTest")) {
				return appendQueryString(resultURL, "com.liferay.portlet.faces.Secure=blue&param1=testValue");
			}
		}
