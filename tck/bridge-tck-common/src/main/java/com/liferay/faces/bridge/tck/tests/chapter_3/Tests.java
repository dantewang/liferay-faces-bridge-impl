...
public class Tests {
	...
	public String lifecycleTest(TestBean testBean) {
		...
		msg = (String) requestMap.get("com.liferay.portlet.faces.tck.testLifecyclePass");

		if (msg != null) {
			pass = true;
		}
		else {
			msg = (String) requestMap.get("com.liferay.portlet.faces.tck.testLifecycleFail");
		}

		// remove them in case we are called to render more than once
		requestMap.remove("com.liferay.portlet.faces.tck.testLifecyclePass");
		requestMap.remove("com.liferay.portlet.faces.tck.testLifecycleFail");
