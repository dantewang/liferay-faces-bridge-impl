...
import com.liferay.portlet.faces.annotation.BridgePreDestroy;
...
public interface PreDestroyInvoker {
	 ...
	 * with the {@link jakarta.annotation.PreDestroy} or {@link BridgePreDestroy}
	 ...
	 *
	 * @param  managedBean       The managed-bean that is to have its {@link jakarta.annotation.PreDestroy} or {@link
	 *                           BridgePreDestroy} annotated method(s) invoked, if any.
	 * @param  preferPreDestroy  Flag indicating that methods annotated with {@link jakarta.annotation.PreDestroy} should
