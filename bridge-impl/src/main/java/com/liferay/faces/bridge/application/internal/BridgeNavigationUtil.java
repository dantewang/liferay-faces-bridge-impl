...
public class BridgeNavigationUtil {
	...
	public static void navigate(PortletRequest portletRequest, StateAwareResponse stateAwareResponse,
		...
		for (Map.Entry<String, String[]> mapEntry : entrySet) {
			...
			// If the URL contains the "com.liferay.portlet.faces.PortletMode" parameter, then set the
			...
			// Otherwise, if the URL contains the "com.liferay.portlet.faces.WindowState" parameter, then
