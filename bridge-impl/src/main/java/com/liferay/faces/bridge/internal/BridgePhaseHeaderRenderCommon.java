...
public abstract class BridgePhaseHeaderRenderCommon extends BridgePhaseCompat_2_2_Impl {
	...
	protected void executeRender(String renderRedirectViewId, Bridge.PortletPhase portletPhase) throws BridgeException,
		...
		// http://javaserverfaces.java.net/nonav/docs/2.0/javadocs/jakarta/faces/context/FacesContext.html#isPostback()
	...
	/**
	 * Sets the "com.liferay.portlet.faces.viewIdHistory.<code>portletMode</code>" session attribute according to the
