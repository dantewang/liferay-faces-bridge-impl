...
@PortletConfiguration(
	portletName = "FACES3300", initParams = {
			@InitParameter(
				name = "com.liferay.portlet.faces.defaultViewId.view", value = "WEB-INF/views/FACES-3300/start.xhtml"
			)
		}, roleRefs = {
...
public class FACES_3300Portlet extends GenericFacesPortlet {
}
