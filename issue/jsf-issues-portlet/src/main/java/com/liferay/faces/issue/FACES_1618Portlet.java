...
@PortletConfiguration(
	portletName = "FACES1618", initParams = {
			@InitParameter(
				name = "com.liferay.portlet.faces.defaultViewId.view",
				value = "/WEB-INF/views/FACES-1618/immediateTrueView.xhtml"
			)
		}, roleRefs = {
...
public class FACES_1618Portlet extends GenericFacesPortlet {
}
