...
public final class BridgePortletResponseFactoryFACES_3404Impl extends BridgePortletResponseFactory {
	...
	private static <T extends BaseURL> T newURLProxy(T t, Class<T> proxyInterface,
		...
		try {
			...
			Class<? extends BaseURL> aClass = t.getClass();

			ClassLoader classLoader = aClass.getClassLoader();

			if (!aClass.getName().startsWith("org.apache.pluto")) {

				Method setDoAsUserIdMethod = aClass.getMethod("setDoAsUserId", long.class);
				...
				classLoader = (ClassLoader) getClassLoaderMethod.invoke(null);
			}
