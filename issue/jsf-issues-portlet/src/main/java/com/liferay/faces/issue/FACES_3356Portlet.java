...
@PortletConfiguration(
	portletName = "FACES3356", initParams = {
			@InitParameter(
				name = "com.liferay.portlet.faces.defaultViewId.view", value = "WEB-INF/views/FACES-3356/start.xhtml"
			)
		}, roleRefs = {
...
public class FACES_3356Portlet extends GenericFacesPortlet {
}
