...
@PortletConfiguration(
	...
	initParams = {
			@InitParameter(
				name = "com.liferay.portlet.faces.defaultViewId.view", value = "/WEB-INF/views/portletViewMode.xhtml"
			),
			@InitParameter(
				name = "com.liferay.portlet.faces.defaultViewId.edit", value = "/WEB-INF/views/portletEditMode.xhtml"
			),
			@InitParameter(
				name = "com.liferay.portlet.faces.defaultViewId.help", value = "/WEB-INF/views/portletHelpMode.xhtml"
			),
